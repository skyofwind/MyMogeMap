...
/**
 * Created by dzj on 2018/3/7.
 */

public class AllRecordsActivity extends BaseActivty {
    private final static String TAG = "AllRecordsActivity";
            ...
            RetrofitUtils.getInstance()
                ...
                .subscribe(new Observer<RunRecords>() {
                    ...
                    public void onError(Throwable e) {
                        log(e.toString());
                        cancelDialog();
                        ToastUtil.tip(AllRecordsActivity.this, "请求出错", 1);
                    }
