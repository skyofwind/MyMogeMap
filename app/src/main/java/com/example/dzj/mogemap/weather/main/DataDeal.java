            ...
            if (str.substring(length - 3, length).equals("自治州")) {
                if (length > 8) {
                    if (str.equals("克孜勒苏柯尔克孜自治州")) {
                        return "克州";
                    } else if (str.substring(length - 8, length).equals("布依族苗族自治州") || str.substring(length - 8, length).equals("哈尼族彝族自治州") || str.substring(length - 8, length).equals("土家族苗族自治州") || str.substring(length - 8, length).equals("蒙古族藏族自治州") || str.substring(length - 8, length).equals("傣族景颇族自治州")) {
                ...
                if (str.substring(length - 3, length).equals("自治县")) {
                    if (length > 13) {
                        ...
                        if (str.equals("喀喇沁左翼蒙古族自治县")) {
                            return ("喀左");
                        } else if (str.substring(length - 10, length).equals("傣族拉祜族佤族自治县") || str.substring(length - 10, length).equals("哈尼族彝族傣族自治县")) {
